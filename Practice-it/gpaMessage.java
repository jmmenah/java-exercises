/*
The following code was intended to print a message when the double gpa variable's value is 3.2, but it actually produces the wrong output. Fix the code to print the expected message.
...
if ((Math.round(credits*100.0)/100.0) == 9.6) {
