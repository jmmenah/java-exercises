...
grant all privileges on javabook.* to 'scott'@'%';
...
# insert into StateCapital values ('Alabama', 'Montgomery');
# insert into StateCapital values ('Alaska', 'Juneau');
# insert into StateCapital values ('Arizona', 'Phoenix');
...
-- @DELIMITER //
create function javabook.studentFound(first VARCHAR(20), last VARCHAR(20))
  returns int
READS SQL DATA
begin
  declare result int;
