...
public class CreateFruitsSQLite {

	private Connection c = SQLiteConnection.getSQLiteConnection("fruits.db");
	...
	public void close() {
		SQLiteConnection.closeSQLiteConnection();
	}

	public static void main(String[] args) throws SQLException {

		CreateFruitsSQLite fruits = new CreateFruitsSQLite();
