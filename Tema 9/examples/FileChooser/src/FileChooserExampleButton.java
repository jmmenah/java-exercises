...
public class FileChooserExampleButton extends JPanel implements ActionListener {

    public static void main(String[] args) {
        JFrame frame = new JFrame("File Chooser Example");
        FileChooserExampleButton content = new FileChooserExampleButton();
    ...
    public FileChooserExampleButton() {
