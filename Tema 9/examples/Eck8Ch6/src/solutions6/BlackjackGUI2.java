/*
 * Chapter 6: Introduction to GUI Programming (JavaFX)
 * http://math.hws.edu/eck/cs124/javanotes8/c6/index.html
 * Introduction to Programming Using Java, Eighth Edition by David J. Eck
 *
 * Exercise 6.11: Programming Exercises for Chapter 6
 * http://math.hws.edu/eck/cs124/javanotes8/c6/exercises.html
 */
package solutions6;
...
public class BlackjackGUI2 extends Application {
    ...
    public void start(Stage stage) {
        ...
        cardImages = new Image("cards/cards.png");
    ...
    void doNewGame() {
        if (gameInProgress) {
                ...
                // to start a new game.  Should be impossible, since
                // the New Game button is disabled when it is not legal to use it.
