...
public class XMLUtils4 {
  ...
  public static void main (String args[]) throws Exception{ 
    ...
    System.out.println(XMLUtils4.validateWithDTDUsingDOM("howto-dtd.xml"));
    System.out.println(XMLUtils4.validateWithDTDUsingSAX("howto-dtd.xml"));

    System.out.println(XMLUtils4.validateWithDTDUsingDOM("howto-dtd-internal.xml"));
    System.out.println(XMLUtils4.validateWithDTDUsingSAX("howto-dtd-internal.xml"));
